...
#include "WraithShooter/Public/BTServices/BTService_PlayerLocationIfSeen.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	WRAITHSHOOTER_API UClass* Z_Construct_UClass_UBTService_PlayerLocationIfSeen_NoRegister();
	WRAITHSHOOTER_API UClass* Z_Construct_UClass_UBTService_PlayerLocationIfSeen();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBTService_PlayerLocationIfSeen_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "BTServices/BTService_PlayerLocationIfSeen.h" },
		{ "ModuleRelativePath", "Public/BTServices/BTService_PlayerLocationIfSeen.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UBTService_PlayerLocationIfSeen, 1220021317);
	template<> WRAITHSHOOTER_API UClass* StaticClass<UBTService_PlayerLocationIfSeen>()
	{
		return UBTService_PlayerLocationIfSeen::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UBTService_PlayerLocationIfSeen(Z_Construct_UClass_UBTService_PlayerLocationIfSeen, &UBTService_PlayerLocationIfSeen::StaticClass, TEXT("/Script/WraithShooter"), TEXT("UBTService_PlayerLocationIfSeen"), false, nullptr, nullptr, nullptr);
